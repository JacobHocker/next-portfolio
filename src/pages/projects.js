...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
    ...
    return(
        ...
        border border-solid border-dark bg-light dark:bg-dark dark:border-light shadow-2xl relative
        ...
        '>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
                ...
                <p className='my-2 font-medium text-dark dark:text-light sm:text-md'>{summary}</p>
...
const Project = ({ type, title, img, link, github }) => {
    ...
    items-center justify-center rounded-2xl border border-solid border-dark bg-light 
    p-6 relative dark:border-light dark:bg-dark xs:p-4 '>
